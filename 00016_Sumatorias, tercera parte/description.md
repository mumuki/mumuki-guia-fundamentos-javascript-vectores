...
sumatoria = sumatoria + unPeriodo[i] _es como decir_: sumatoria = sumatoria + unPeriodo[0]


La segunda vuelta del for es:

sumatoria = sumatoria + unPeriodo[i] _es como decir_: sumatoria = sumatoria + unPeriodo[1]


La tercer vuelta del for es:

sumatoria = sumatoria + unPeriodo[i] _es como decir_: sumatoria = sumatoria + unPeriodo[2]
